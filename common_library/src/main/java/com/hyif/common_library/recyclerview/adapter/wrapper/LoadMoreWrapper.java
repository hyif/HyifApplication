...
public class LoadMoreWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private RecyclerView.Adapter mInnerAdapter;//原装适配器
  ...
  private ViewHolder getLoadMoreViewHolder() {
    if (mLoadMoreView == null) {
      ...
      mLoadMoreView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
  ...
  private ViewHolder getLoadErrorViewHolder() {
    if (mLoadErrorView == null) {
      ...
      mLoadErrorView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
          ViewGroup.LayoutParams.WRAP_CONTENT));
  ...
  private ViewHolder getNoMoreViewHolder() {
    if (mNoMoreView == null) {
      ...
      mNoMoreView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
          ViewGroup.LayoutParams.WRAP_CONTENT));
